    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <Link href="/data-rights" className="block">
            <div className="bg-white shadow rounded-lg p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-medium text-gray-900">Direitos de Dados</h3>
              ...
              <p className="text-gray-600 text-sm">
                Exerça seus direitos de acesso, correção e exclusão de dados (LGPD).
              </p>
            </div>
          </Link>
        </div>
