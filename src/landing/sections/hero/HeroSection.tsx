    ...
    return (
      <section className="relative min-h-[70vh] flex items-center overflow-hidden bg-site-bg">
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <h1 className="text-5xl md:text-7xl font-light tracking-tight leading-tight text-site-text mb-6">
            {profile.displayName}
          </h1>
          <p className="text-xl text-site-text-muted font-light mb-8">{profile.city}</p>
          <p className="text-2xl text-site-text-muted font-light leading-relaxed max-w-2xl mb-10">
            {profile.description}
          </p>
          <button
    ...
    return (
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-site-bg">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-light tracking-tight leading-tight text-site-text mb-4">
            {profile.displayName}
          </h1>
          <p className="text-xl text-site-text-muted font-light mb-8">{profile.city}</p>
          <p className="text-2xl text-site-text-muted font-light leading-relaxed max-w-2xl mx-auto mb-10">
            {profile.description}
          </p>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-5xl md:text-7xl font-light tracking-tight leading-tight text-site-text">
                {profile.displayName}
              </h1>
              <p className="text-xl text-site-text-muted font-light">{profile.city}</p>
            </div>

            <p className="text-2xl text-site-text-muted font-light leading-relaxed max-w-xl">
              {profile.description}
            </p>
          ...
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-br from-site-surface to-site-bg rounded-3xl p-12 backdrop-blur-xl border border-white/5">
