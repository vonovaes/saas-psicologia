...
export const config = {
  matcher: [
     ...
     */
    '/((?!^$|privacy|api/health|api/public|api/tenant-resolve|api/test-tenant-resolution|api/test-resolve|api/test-db|api/debug-tenant|api/auth|api/profile|api/faq|api/lead|_next/static|_next/image|favicon.ico).*)',
  ],
};
